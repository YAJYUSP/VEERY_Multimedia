...
void bsp_nrf_rx_mode(void)
{
		...
		NRF24L01_Write_Buf(NRF_WRITE_REG+RX_ADDR_P0,(uint8_t*)nrf0.RX_ADDRESS,RX_ADR_WIDTH);//写RX节点地址
...
{														 
		NRF24L01_CE_LOW();	    
		NRF24L01_Write_Buf(NRF_WRITE_REG+TX_ADDR,(uint8_t*)nrf0.TX_ADDRESS,TX_ADR_WIDTH);//写TX节点地址 
		NRF24L01_Write_Buf(NRF_WRITE_REG+RX_ADDR_P0,(uint8_t*)nrf0.RX_ADDRESS,RX_ADR_WIDTH); //设置TX节点地址,主要为了使能ACK	  
