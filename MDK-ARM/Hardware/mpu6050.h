...
//static uint8_t MPU_Write_Len(uint8_t reg,uint8_t len,uint8_t *buf);
static uint8_t MPU_Read_Len(uint8_t reg,uint8_t len,uint8_t *buf);
//static uint8_t DMP_Write_Len(uint8_t addr, uint8_t reg,uint8_t len,uint8_t *buf);
//static uint8_t DMP_Read_Len(uint8_t addr, uint8_t reg,uint8_t len,uint8_t *buf);
